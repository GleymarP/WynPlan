...
void TeacherEditorDialog::set_professor_info(const Professor &professor)
{
    ui->label_title->setText("Eliminar profesor");
    ui->label_teacger_id->setText("Cédula: " + QString::fromStdString(professor.get_id()));
    ui->label_teacher_name->setText("Nombre: " + QString::fromStdString(professor.get_full_name()));
