...
public:
    explicit TeachersWindow(std::vector<Professor>& professor, StudyPlan& plan, std::vector<Assigment>& assigments, QWidget *parent = nullptr);
    ~TeachersWindow();
...
private:
    ...
    StudyPlan plan_;
    std::vector<Assigment> assigments_;
